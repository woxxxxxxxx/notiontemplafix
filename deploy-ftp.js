...
const FTP_PORT    = 21;
const FTP_USER    = 'u868313694.notiontemplafix.com';
const FTP_PASS    = 'Xxh113324~';
const REMOTE_ROOT = '/public_html';
const SITE_URL    = 'https://notiontemplafix.com';
const SITE_NAME   = 'notiontemplafix';
const CONCURRENCY = 5;
const RETRY_MAX   = 3;
...
const EXCLUDE_NAMES = new Set([
  ...
  'pinterest', 'package.json', 'package-lock.json',
...
const EXCLUDE_PREFIXES = ['buffer', 'ftp_', 'gen_', 'screenshot', 'take_', 'update_',
  'create_', 'fix_', 'inject_', 'payhip_', 'regen_', 'record_'];
const EXCLUDE_EXTS = new Set(['.py', '.sh', '.ps1', '.mp4']);
